...
RFQ should be postively correlated with RFv and have a close relationship
...
We observed low ADF and NDF values, but they were within an acceptable range. The RFV calculation (205), however, was outside the expected range of 100-200. When we compared our NIRS prediction with Europe, we underpredicted ADF and NDF. I suspect we are overestimating RFV by underestimating ADF and NDf

Our NDFD range is also low. GET EXPECTED VALUES. We observe a range of 4 to 31. We think it should be about double that. 

Let's see how the RFV-RFQ relationship changes when we almost triple NDFD and increase ADF and NDF by 20%. 
